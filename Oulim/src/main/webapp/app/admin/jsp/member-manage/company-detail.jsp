...
<head>
  ...
  <title>기업회원상세</title>
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/component/pagination.css"><link rel="stylesheet" href="${pageContext.request.contextPath}/asset/css/component/input.css" />
  ...
  <script defer src="${pageContext.request.contextPath}/app/admin/js/member-manage/company-detail.js"></script>
